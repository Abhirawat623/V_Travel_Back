...
wishlistRouter.route("/").post(verifyUser, async (req, res) => {
...
wishlistRouter.route("/").delete(verifyUser, async (req, res) => {
  try {
...
wishlistRouter.route("/").get(verifyUser, async (req, res) => {
  try {
